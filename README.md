...
```md
[kem198/copy-md-link](https://github.com/kem198/copy-md-link)
```
...
2. ブックマークを次のとおり編集する。
    1. 名前: お好みの名前
    2. URL: 次のコード全文を挿入して保存する。

        [copy-md-link.js](copy-md-link.js)

    <img width="467" height="556" alt="image" src="https://github.com/user-attachments/assets/d434c9bb-3267-43f1-a1b8-80bcd3335260" />
...
(3) についてはハッシュ記号 `#` をエスケープする文字として追加しています。Obsidian などの Markdown エディタにおいて、タイトルに含まれる `#` から続く文字列が [タグとして表示](https://publish.obsidian.md/help-ja/ガイド/タグの操作) されてしまうケースがあるためです。
...
[デコード処理を省いたもの](copy-md-link-nondecord.js) も用意しているので、用途に応じてご使用ください。
