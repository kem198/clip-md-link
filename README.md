...
2. ブックマークを次のとおり編集する。
    ...
    2. URL: 次のコード全文を挿入して保存する。
        ...
        [copy-md-link.js](dist/copy-md-link.js)

    ![bookmark-editing.png](images/bookmark-editing.png)
...
[デコード処理を省いたもの](dist/copy-md-link-nondecord.js) も用意しているので、用途に応じてご使用ください。
